...
from .views import LoginView, get_month_wise_total_duration_all_users,get_monthly_reports,create_task_entry,update_task_entry,delete_task_entry,get_tasks_for_today
from web import views
...
urlpatterns = [
    ...
    path('api/task-duration', get_monthly_reports, name='task-duration'),
       path('api/month-wise-total-duration/', get_month_wise_total_duration_all_users, name='month-wise-total-duration'),
]
